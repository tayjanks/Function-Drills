...
const bestMovie = str => {console.log(str+" is the best movie ever!")};

let movieCheck = bestMovie("Sharknado");
...
function bigOrSmall (arr) {
  let answers = [];
  for (let i=0; i < arr.length; i++){ if (arr[i] > 100) {answers.push("big")}
else if (arr[i] <= 100){answers.push("small")}};
console.log(answers);
}
...
let hungerGames = theEliminator(contestants,loser);
...
console.log (emailCheck ("taylor@gmail.com"))
////////////////// PROBLEM 19 ////////////////////
/*
